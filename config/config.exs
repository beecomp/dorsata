...
config :dorsata, DorsataWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: DorsataWeb.ErrorHTML, json: DorsataWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Dorsata.PubSub,
  live_view: [signing_salt: "tybvC7y0"]
...
config :dorsata, Dorsata.Mailer, adapter: Swoosh.Adapters.Local
